...
$page_master = getPageMaster($_SESSION['veri_page']);
...
<div id="main">
  ...
  <br/>
      <p class="text-center">The page, <b><?php echo $_SESSION['veri_page'] ?></b> , you are trying to access contains sensitive functions. <br/><br/>
        ...
        <br/><?php echo "File 2 sent to page master : <b>" . $page_master; ?></b> 
        <br/><br/>We require you to confirm your identity by uploading <b>BOTH</b> files.</p>
      <br>
      <?php echo message(); ?>
